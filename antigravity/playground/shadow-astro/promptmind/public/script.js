...
function speakVocalBriefing() {
    ...
    if (vocalBtn && vocalBtn.classList.contains('speaking')) {
    ...
    if (vocalBtn) {
        utterance.onstart = () => {
            // Also reset any active message speaker buttons
            document.querySelectorAll('.message-audio-btn').forEach(btn => {
                btn.innerHTML = '<i class="fa-solid fa-volume-low"></i> SPEAK';
                btn.classList.remove('speaking');
            });
            vocalBtn.innerHTML = '<i class="fa-solid fa-stop"></i>';
            vocalBtn.classList.add('speaking');
        };
        const resetVocalBtn = () => {
            vocalBtn.innerHTML = '<i class="fa-solid fa-volume-low"></i>';
            vocalBtn.classList.remove('speaking');
            activeSpeechUtterance = null;
        };
        utterance.onend = resetVocalBtn;
        utterance.onerror = resetVocalBtn;
    }
    ...
    function addSpeakerBtn(contentDiv, text) {
        ...
        speakerBtn.addEventListener('click', () => {
            ...
            utterance.onstart = () => {
                ...
                // Reset header vocal brief button
                const vocalBtn = document.getElementById('vocal-brief-btn');
                if (vocalBtn) {
                    vocalBtn.innerHTML = '<i class="fa-solid fa-volume-low"></i>';
                    vocalBtn.classList.remove('speaking');
                }
                speakerBtn.innerHTML = '<i class="fa-solid fa-stop"></i> STOP';
